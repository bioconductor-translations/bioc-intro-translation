...
- スプレッドシートについて、その長所と短所を学ぶ。
- 効果的なデータ活用のために、スプレッドシートのデータをどのようにフォーマットするか？
- スプレッドシートのよくあるエラーとその修正方法について学ぶ。
- tidy data の原則に従ってデータを整理する。
- カンマ区切り (CSV) やタブ区切り (TSV) などのテキストベースのスプレッドシート形式について学ぶ。
