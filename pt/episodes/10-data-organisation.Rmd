...
- Aprenda sobre tabelas, seus pontos fortes e fraquezas.
- Como formatamos dados em tabelas para o uso eficaz dos dados?
- Aprenda sobre erros comuns da manipulação de tabelas e como corrigi-los.
- Organize os seus dados de acordo com os princípios *tidy*.
- Saiba mais sobre os formatos de tabelas, como as tabelas separadas por vírgulas (CSV) ou separadas por tabulações (TSV).
...
formato de tabela. Programas de análise de tabelas são interfaces
gráficas muito úteis para projetar dados e lidar com funções e controle de qualidade. Ver também @Broman:2018.

### O perfil da tabela

Tabelas são boas para a inserção de dados. Portanto, temos muitos dados
em tabelas.  Muito do seu tempo como pesquisador será gasto em
desembaralhar seus dados e a forma como foram inseridos.  It's not the most fun, but it's
necessary. Vamos te ensinar como pensar sobre organização de dados e
algumas práticas para um melhor desembaraço dos dados.

### O que esta aula não vai te ensinar

- Como fazer *estatísticas* em uma tabela
- Como *plotar figuras* a partir de uma tabela
- Como *escrever código* em programas de tabela
...
### Por que não podemos ensinar análises de dados em tabelas

- Análise de dados em tabelas geralmente requerem muito trabalho manual. Se você alterar um parâmetro ou efetuar uma análise com um
  novo conjunto de dados, normalmente terá de refazer tudo à mão. (We do
